...
+(function ($) {
  ...
  var CALENDAR_OPTION = {
    ...
    numbers: ["First", "Second", "Third", "Fourth", "Fifth", "Six"], //数字标示
    today: true, //是否标志今天
    select: true, //是否单击选中
    multi: false, //是否单击可多选
  ...
  Calendar.prototype.changeCH = function (element, options) {
    ...
    if (type == "monthly") {
      ...
      header.text(year + " · " + this.dispose(month));
    }
  };
        ...
        if (selectDate) {
          ...
          if (
            ...
            calendar +=
              ...
              "-" +
              this.dispose(endDay) +
              '" colspan="7"><div><span class="week">' +
              numbers[j] +
              ' Week</span><span class="process">' +
              this.dispose(startMonth) +
              "/" +
              this.dispose(startDay) +
              "~" +
  ...
  Calendar.prototype.toEn = function (val) {
    switch (val) {
      case 1:
        return "Jan";
        break;
